...
codesign --force --sign - --identifier io.meetingsummary.audiocap ".build/release/audiocap" 2>/dev/null \
  && echo "ad-hoc signed (io.meetingsummary.audiocap)" || echo "WARN: codesign failed (TCC may not persist)"
